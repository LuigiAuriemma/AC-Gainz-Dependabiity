 ...
 * Testa i tre scenari principali: Utente Guest, Utente Loggato (non admin) e Utente Admin.
 */
public class AccessControlFilterTest {
     ...
     * Verifica che sendRedirect sia stato chiamato e che la catena sia stata interrotta.
     */
    private void assertRedirectedTo(String targetPath) throws IOException, ServletException {
        ...
        // VERIFICA CHIAVE: la richiesta non deve proseguire (non deve chiamare il filtro successivo)
